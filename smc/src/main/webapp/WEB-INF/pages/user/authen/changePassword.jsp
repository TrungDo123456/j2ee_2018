  ...
  <div class="container">
    <div class="card card-login mx-auto mt-5">
      ...
      <div class="card-body">
        ...
        <s:form action="forgot_password" method = "post">
        <div class="form-group">
            <s:label for="exampleInputEmail1">Your Email</s:label>
            <input name="to" class="form-control" type="email" aria-describedby="emailHelp" placeholder="Enter your email">
        </div>
			<s:submit class="btn btn-primary btn-block" label="Login" align="center" value="Reset password"/>
		</s:form>
      </div>
    </div>
  </div>
